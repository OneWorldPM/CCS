                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php } else if ($val->status == 1) { ?>
                                                            <a href="<?= base_url() ?>admin/sessions/start_timer/<?= $val->sessions_poll_question_id ?>" class="btn btn-blue btn-sm">Start Timer: 10s'</a>
                                                            <a href="<?= base_url() ?>admin/sessions/start_timer15sec/<?= $val->sessions_poll_question_id ?>" class="btn btn-blue btn-sm">Start Timer: 15s'</a>
