                                ...
                                <div class="col-md-7 m-t-20" style="border-right: 1px solid;">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <small><i class="fa fa-calendar" aria-hidden="true"></i> <?= date("M-d-Y", strtotime($sessions->sessions_date)) . ' ' . date("h:i A", strtotime($sessions->time_slot)) . ' - ' . date("h:i A", strtotime($sessions->end_time)) ?> ET</small>
                                ...
                                <div class="col-md-5" style="text-align: center;">
                                    ...
                                    if (isset($sessions->presenter) && !empty($sessions->presenter)) {
                                        foreach ($sessions->presenter as $value) {
                                            ?>
                                            <h3 style="margin-bottom: 0px; " data-presenter_photo="<?= $value->presenter_photo ?>" data-degree="<?= $value->degree ?>" data-presenter_name="<?= $value->presenter_name ?>" data-designation="<?= $value->designation ?>" data-email="<?= $value->email ?>" data-company_name="<?= $value->company_name ?>" ><?= $value->presenter_name ?><?= ($value->degree)?", ".$value->degree:"" ?></h3>
